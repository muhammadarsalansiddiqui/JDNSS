...
public class OPTRRTest {
    private final byte[] bytes = {(byte) 0x00, (byte) 0x00, (byte) 0x29, (byte) 0x10,
    ...
    private final byte[] cookie = {(byte) 0x33,
            (byte) 0x9c, (byte) 0xd1, (byte) 0xf3, (byte) 0xaf,
            (byte) 0x36, (byte) 0x46, (byte) 0x21};
    private final byte[] buffer = {(byte) 0x6b, (byte) 0xcd, (byte) 0x01, (byte) 0x20,
    ...
    public void createServerCookieTest() {
        ...
        Assert.assertEquals(query.getHeader().toString(), copyQuery.getHeader().toString());
        ...
        Assert.assertNotEquals(query.getHeader().toString(), copyQuery.getHeader().toString());
